"""
Django settings for chihuoapp project.
...
SECRET_KEY = 'k#-ghsq)alfc7^x%or^r+q&5w=y2eyw-*z@36)q=1zf8kje!(b'
...
WSGI_APPLICATION = 'chihuoapp.wsgi.application'
